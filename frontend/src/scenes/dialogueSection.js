export default class DialogueOverlayScene extends Phaser.Scene {
    ...
    if(item.name === 'leaver'){
        this.dialogueLines = [
            "Welcome to the data collection test game",
            "In this adventure, you should aim to collect as many eggs as possible.", 
            "Remember to watch out for the enemy and escape!",
        ];
